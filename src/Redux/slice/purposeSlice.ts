...
import { ICreatingPurpose, IPersonalPurposeParams, IPurpose } from '../../models/IPurpose';
...
export const purposesSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(getPersonalPurpose.fulfilled, (state, action:PayloadAction<IPurpose>) => {
        ...
        builder.addCase(getChallengePurpose.fulfilled, (state, action:PayloadAction<IPurpose>) => {
            state.purpose = action.payload
            state.isLoading = false
        })
    }
...
export const {setQuantityPurpose,setRewardPurpose,setTypePurpose} = purposesSlice.actions


export const purposeSelector = (state: RootState) => state.purposes.purpose
export const creatingPurposeSelector = (state: RootState) => state.purposes.creatingPurpose
