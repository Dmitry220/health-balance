...
export const shopSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getShopCategories.fulfilled, (state, action:PayloadAction<IShopCategory[]>) => {
    ...
    builder.addCase(getProductsCategory.fulfilled, (state, action:PayloadAction<IShopProduct[]>) => {
...
export const shopCategoriesSelector = (state: RootState) => state.shop.categories;
