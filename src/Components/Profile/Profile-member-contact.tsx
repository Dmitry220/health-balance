    ...
    return (
        <div className={'profile-member-contact'}>
            <div className="profile-member-contact__row">
                ...
                <div className="profile-member-contact__value title-17">{infoUser.email}</div>
                <div className="profile-member-contact__caption">Телефон</div>
                <div className="profile-member-contact__value title-17">{infoUser.phone}</div>
                <div className="profile-member-contact__caption">Дата рождения</div>
                <div className="profile-member-contact__value title-17">{new Date(infoUser.birthday*1000).toLocaleDateString()}</div>
            </div>
        </div>
    );
};
