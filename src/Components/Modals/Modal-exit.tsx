    ...
    <div className="modal">
      ...
      <div className="modal__wrapper">
        <div className="modal__button-wrapper">
          <div className="modal__text">Вы действительно хотите выйти из аккаунта?</div>
          <div className="modal__button modal__button_exit" onClick={() => actionCallback()}>{text || 'Выйти'}</div>
