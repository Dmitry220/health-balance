...
import { dataRegistrationSelector, platformSelector, resetFieldRegistration, setAuth, typePlatformSelector } from '../../Redux/slice/authSlice'
	...
	return (
		<div className='auth-google'>
			...
			<div className="auth-google__container">
				<h2 className='auth-google__title main-title'>Когда у вас день
					рождения?</h2>
				...
				<Platform googleAuth={true} />
				{
					typePlatfotm === 2 &&
					<>
						<h2 className='auth-google__title main-title'>Укажите код платформы</h2>
						<Privateplatform googleAuth={true} />
					</>

				}
				{!isLoading ?<button type="button" className="google-sign-in-button"
					onClick={googleAuth}>
					Sign in with Google
				</button> :
