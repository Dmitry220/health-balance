    ...
    return (
        <div className={'type-challenge'}>
            ...
            <div className="type-challenge__body" onChange={handlerType}>
                <input type="radio" name={'type-challenge'} value={1} id={'personal'} defaultChecked={type===1} className="type-challenge__input" />
                <label htmlFor="personal" className="type-challenge__label">Личный</label>
                <input type="radio" name={'type-challenge'} value={2} className="type-challenge__input" id={'command'} defaultChecked={type===2}/>
