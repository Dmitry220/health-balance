...
export const CommentForm:FC<ICommentForm> = ({parentId, author,setShowForm}) => {
  ...
  const submit = async () => {
    console.log(message, idNews, parentId);
  ...
  return (
    <div className={'comment-form'}>
      {author && <div className='comment-form__answer-author'>Вы отвечаете <span>{author}</span></div>}
