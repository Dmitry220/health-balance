...
import { getNewsById, isLoadingSelector, newsByIdSelector } from '../../Redux/slice/newsSlice';
...
export const MotivationCard = () => {
    ...
    return (
        <>
            {news && <div className={'motivation-card'}>
                ...
                <div className="motivation-card__body">
                    ...
                    <div className="motivation__feed-back feed-back">
                        <div className="feed-back__favourite"><img src={iconFavourite} alt="favourite" />{news.likes}</div>
