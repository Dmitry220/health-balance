    ...
    <div className={'shop-page'}>
      ...
      <TabContent index={0} value={valueTab}>
        <div className='shop-page__cards'>
          <Link
            to={PRODUCT_SCREEN_ROUTE + '/0'}
            className='shop-page__item-card'
          >
            <ShopCard />
          </Link>
          <Link
            to={PRODUCT_SCREEN_ROUTE + '/1'}
            className='shop-page__item-card'
          >
            <ShopCard />
          </Link>
          <Link
            to={PRODUCT_SCREEN_ROUTE + '/2'}
            className='shop-page__item-card'
          >
            <ShopCard />
          </Link>
          <Link
            to={PRODUCT_SCREEN_ROUTE + '/3'}
            className='shop-page__item-card'
          >
            <ShopCard />
          </Link>
      ...
      <TabContent index={3} value={valueTab}>
        <div className='shop-page__text'>
          В этой категории предложения закончились :(
        </div>
      </TabContent>
