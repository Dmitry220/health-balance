...
export const Questionnaire = () => {
    ...
    const [saveCurrentPollResults, {isLoading: isLoadingSaveCurrent}] = useSaveCurrentResultMutation()
    ...
    const saveCurrentResult = async () => {
        ...
        await saveCurrentPollResults(data).unwrap().catch((e) => showToast(e.data))
    }
